///////////////建立假数据
var date=[
  {song:"晴天",geshou:"关诗敏",time:"3:43",src:"./关诗敏 - 晴天 (Live).mp3"},
  {song:"受了点伤",geshou:"Various Artists",time:"3:35",src:"./Various Artists - 受了点伤.mp3"},
  {song:"我可以",geshou:"蔡旻佑",time:"4:13",src:"./蔡旻佑 - 我可以 (Live).mp3"},
